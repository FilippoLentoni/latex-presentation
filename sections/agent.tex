...
\begin{quote}
Would a reservation to the definition of torture in the International Covenant on Civil
and Political Rights (ICCPR) be acceptable in contemporary practice?
\begin{itemize}
  \item A) Acceptable if the reserving country's legislation employs a different definition.
  \item B) Unacceptable because it contravenes the object and purpose of the ICCPR.
  \item C) Unacceptable because the definition of torture in the ICCPR is consistent with customary international law.
  \item D) Acceptable because under general international law States have the right to enter reservations to treaties.
\end{itemize}
\end{quote}

\textbf{Correct answer: B} (as provided in benchmark sample).
